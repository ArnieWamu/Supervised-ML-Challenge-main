...
When fitted along each other and used to train unscaled data, both classifiers seemed to fail, but when trained scaled data, the Random Forest Classifier model turned out to be the best model to use.
